...
for i in range(3):
    ...
    grid_serch_result.append(f1)
    print(f1, f1_micro, f1_weighted, average_auc)
index = grid_serch_result.index(max(grid_serch_result))
print("best hyper parm: learning_rate:", lr_list[index])
print(grid_serch_result)